import { CjsDOMElements } from "../CjsDOMElements";
...
export class CjsComponent<TData = any> {
    ...
    private getHtml(data: any, style: Partial<CSSStyleDeclaration> = {}): string {
        ...
        const virtualElement = CjsDOMElements.createNewVirtualElement();
        ...
        const onLoadAttribute = mutationListener.listen("add", async (cjsEvent) => {
            if(isAsync) {
                ...
                cjsEvent.source.outerHTML = this.addAttributes(
                    ...
                    [this.attribute, virtualElement.getHTMLAttribute()]
                );
            }
            this.executeOnLoad();
        }) as string;
        ...
        return this.addAttributes(
            ...
            [this.attribute, onLoadAttribute.trim(), virtualElement.getHTMLAttribute()]
        );
    }
