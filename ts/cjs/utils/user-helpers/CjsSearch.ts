...
import { _DOMElementsUtil } from "../protected/_DOMElementsUtil";
...
export const CjsSearch = new class CjsSearch {
    ...
    get<T>(index: number): T | null {
        ...
        if (outOfRange) {
            _CjsLoggerUtil.error("Provided index is too high");
            return null;
        }

        return split[index] as T;
    }
